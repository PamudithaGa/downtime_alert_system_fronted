...
var require_freshRequire = __commonJS({
  "node_modules/chartjs-node-canvas/dist/freshRequire.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.freshRequire = void 0;
    var freshRequire = (file) => {
      const resolvedFile = __require.resolve(file);
      const temp = __require.cache[resolvedFile];
      delete __require.cache[resolvedFile];
      const modified = __require(resolvedFile);
      __require.cache[resolvedFile] = temp;
      return modified;
    };
...
// node_modules/chartjs-node-canvas/dist/backgroundColourPlugin.js
var require_backgroundColourPlugin = __commonJS({
  "node_modules/chartjs-node-canvas/dist/backgroundColourPlugin.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BackgroundColourPlugin = void 0;
    var BackgroundColourPlugin = class {
...
// node_modules/chartjs-node-canvas/dist/chartJSNodeCanvasBase.js
var require_chartJSNodeCanvasBase = __commonJS({
  "node_modules/chartjs-node-canvas/dist/chartJSNodeCanvasBase.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ChartJSNodeCanvasBase = void 0;
    var path_1 = require_path();
    var freshRequire_1 = require_freshRequire();
    var backgroundColourPlugin_1 = require_backgroundColourPlugin();
    var ChartJSNodeCanvasBase = class {
      /**
      ...
      initialize(options) {
        ...
        if ((_a = options.plugins) === null || _a === void 0 ? void 0 : _a.requireChartJSLegacy) {
          for (const plugin of options.plugins.requireChartJSLegacy) {
            __require(plugin);
            delete __require.cache[__require.resolve(plugin)];
          }
        }
...
// node_modules/chartjs-node-canvas/dist/animatedChartJSNodeCanvas.js
var require_animatedChartJSNodeCanvas = __commonJS({
  "node_modules/chartjs-node-canvas/dist/animatedChartJSNodeCanvas.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AnimatedChartJSNodeCanvas = void 0;
    var chartJSNodeCanvasBase_1 = require_chartJSNodeCanvasBase();
    var animationFrameProvider = {
      cancelAnimationFrame: (handle) => clearImmediate(handle),
      requestAnimationFrame: (callback) => setImmediate(() => callback(Date.now()))
    };
    var AnimatedChartJSNodeCanvas = class extends chartJSNodeCanvasBase_1.ChartJSNodeCanvasBase {
      /**
      ...
      renderChart(configuration, onProgress, onComplete) {
        ...
        animation.onProgress = (event) => {
          ...
          const initial = !!event.initial ? event.initial : false;
...
// node_modules/chartjs-node-canvas/dist/chartJSNodeCanvas.js
var require_chartJSNodeCanvas = __commonJS({
  "node_modules/chartjs-node-canvas/dist/chartJSNodeCanvas.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ChartJSNodeCanvas = void 0;
    var chartJSNodeCanvasBase_1 = require_chartJSNodeCanvasBase();
    var ChartJSNodeCanvas = class extends chartJSNodeCanvasBase_1.ChartJSNodeCanvasBase {
      /**
...
var require_dist = __commonJS({
  "node_modules/chartjs-node-canvas/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
    tslib_1.__exportStar(require_animatedChartJSNodeCanvas(), exports);
    tslib_1.__exportStar(require_chartJSNodeCanvas(), exports);
    tslib_1.__exportStar(require_chartJSNodeCanvasBase(), exports);
  }
});
...
chart.js/dist/chart.cjs:
   ...
   *)
*/
//# sourceMappingURL=chartjs-node-canvas.js.map
